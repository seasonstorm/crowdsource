// pages/my_releasetask/my_releasetask.js
...
Page({
  ...
  longPress: function (e) {
    ...
    wx.showModal({ //使用模态框提示用户进行操作
      title: '提示',
      content: '请问您是否需要删除该条任务',
      success: (res) => {
        if (res.confirm) { //判断用户是否点击了确定
          taskFuc.deleteMyTask(that, this.data.list[e.currentTarget.dataset.index].task_id,e)
        }
      }
    })
  },
